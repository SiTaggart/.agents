...
- **QMD search** (direct, no subagent needed) - `mcp__qmd__query` with the PR title and changed modules against both `ai` and `docs` collections. Surface design docs that motivated these changes, prior specs with constraints, and related meeting notes. Include relevant findings in the synthesis step.
