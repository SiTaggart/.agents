...
description: "Iteratively refines UI through screenshot-analyze-improve cycles. Use when design changes aren't converging after 1-2 attempts or the user asks for iterative refinement."
color: violet
model: inherit
---
