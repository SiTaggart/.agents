...
description: Always-on code-review persona. Reviews code for test coverage gaps, weak assertions, brittle implementation-coupled tests, and missing edge case coverage. Also handles test-strategy asks -- suite design, unit/integration/E2E balance, and slow-suite optimization.
model: inherit
