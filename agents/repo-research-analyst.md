...
1. **Architecture and Structure Analysis**
   ...
   - **Search QMD** for project-level documentation and prior designs: `mcp__qmd__query` with the research focus against both `ai` and `docs` collections. Look for specs, meeting notes, and archived decisions that supplement codebase analysis. For subagents without MCP: `qmd query "research topic"` via Bash
