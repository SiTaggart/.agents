...
- **Open in Proof (web app) — review and comment to iterate with the agent** -> Load the `proof` skill in HITL-review mode with:
  - source file: `.ai/plans/<plan_filename>.md`
