...
- **Source / composition signal.** A visible footer at the bottom of
  ...
  `<footer class="composition-signal">Composed 2026-05-17T14:23Z by ce-plan from <code>.ai/brainstorms/...-requirements.md</code></footer>`.
...
- **Repo-relative code/doc paths** (`services/foo.ts`,
  `.ai/solutions/bar.md`) → `<repo-url>/blob/main/<path>`.
