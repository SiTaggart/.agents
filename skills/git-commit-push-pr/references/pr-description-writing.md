...
Place any evidence block near the end of the body. Do not label test output as "Demo" or "Screenshots."
...
- Bad: "This PR adds a new `evidence-decider.ts` module, modifies `git-commit-push-pr/SKILL.md` to call it, and updates two test files."
