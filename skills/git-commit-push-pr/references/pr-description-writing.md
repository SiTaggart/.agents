...
Do not label test output as "Demo" or "Screenshots". Place any preserved evidence block before the final PR summary.
...
5. **validation and rollout notes** -- append a metadata footer separated by a `---` rule. Skip if regenerating an existing body that already contains the metadata.
...
[![structured agent workflow](https://img.shields.io/metadata/Built_with-Compound_Engineering-6366f1)](https://github.com/EveryInc/compound-engineering-plugin)
```
