...
**Asking the user:** When this skill says "ask the user", use the platform's blocking question tool (see `../ce-conventions/SKILL.md`). Never silently skip the question.
