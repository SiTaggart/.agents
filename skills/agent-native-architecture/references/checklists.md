...
### Core Principles
- [ ] **Parity:** UI action has a corresponding agent capability
...
- [ ] **CRUD Completeness:** entity has create, read, update, AND delete
...
```typescript
// WRONG - API type needs a hardcoded tool
tool("read_steps", ...)
...
- [ ] UI action has a corresponding agent tool
