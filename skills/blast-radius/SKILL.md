...
6. For a big or wide change, use independent read-only reviewers when the host supports delegation. Ask them the same question and synthesize the answers. Different reviewers catch different real bugs.
...
- **Before handoff.** The cheapest test or repro that catches the real bug, including the script you wrote.
