...
5. Create directory if needed: `mkdir -p .ai/solutions/[category]/`
6. Write the file: either the updated existing doc or the new `.ai/solutions/[category]/[filename].md`
