...
**If no document is specified:** Ask which document to review, or look for the most recent brainstorm/plan in `.ai/brainstorms/` or `.ai/plans/`.
...
- **Does this contradict or duplicate existing documented decisions?** (check QMD results)
