---
name: improve
description: Audit a codebase read-only and produce prioritized implementation plans. Use for bugs, security, performance, tests, tech debt, DX, or roadmap ideas.
license: MIT
metadata:
  author: shadcn
  version: "1.0.0"
