...
This skill runs for hours. Context windows compact, sessions crash, and agents restart. piece of state that matters MUST live on disk, not in the agent's memory.
